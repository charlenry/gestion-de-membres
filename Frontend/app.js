/** 
 * Base URL API server: http://localhost:8080
 * Frontend URL: http://localhost:8081
 * Swagger doc: http://localhost:8080/api/v1/api-docs
 * Gitbook Doc: https://charlenry.gitbook.io/api-rest-for-member-management/
*/
